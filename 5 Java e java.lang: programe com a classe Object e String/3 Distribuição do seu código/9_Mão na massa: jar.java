...
1 - No Eclipse, clicando com o botão direito no projeto bytebank-herdado-conta, selecione a opção export. Diversas opções de exportação serão exibidas, selecione aquela dentro do grupo java e dentro dele a opção JAR File clicando em "NEXT". Vejamos o próximo passo a seguir.
