 ...
 * 
 * Ao acessar uma posição inválida recebemos a exceção
 * ArrayIndexOutOfBoundException
 * 
 * Arrays possuem um atributo length para saber o tamanho
 * A forma literal de criar uma Array, com o uso de chaves {}.
 * 
 * No próximo capítulo falaremos mais um pouco sobre arrays (do tipo Object) e
 * veremos como funciona esse parâmetro do método main.
 */