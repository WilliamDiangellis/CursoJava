// 1) Agora começaremos a implementar o método de ordenação baseado no nome do titular da conta. Para tal crie 
// uma nova classe de teste (ou use a antiga) que possui o bloco de código abaixo:
...
// 2) Como criaremos outro critério de comparação, adicione outra classe que também implementa a interface Comparator. 
// Já implementando os critérios de ordenação, teremos o seguinte:
