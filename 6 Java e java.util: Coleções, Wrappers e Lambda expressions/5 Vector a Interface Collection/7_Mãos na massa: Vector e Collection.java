...
// Repare que todo o resto do código continua funcionando, independente da lista utilizada. Isto ocorre pois
// todas as implementações são listas.
...
// Repare que algumas linhas de código param de compilar, justamente os métodos que usam a posição, como
// remove(int pos) ou get(int pos). Isto ocorre pois apenas listas são sequências e possuem um índice, mas
// há outras coleções que funcionam sem índice e consequentemente não possuem esses métodos.
