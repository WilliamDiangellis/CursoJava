// Se você fez o exercício Será que o Miguel entendeu a aula?, vai lembrar o que
// aprendemos. Para fixar ainda mais, listamos os tópicos dessa aula:
...
// É na classe Throwable que temos praticamente todo o código relacionado às
...
// Classes que herdam de Error são usadas para comunicar erros na máquina
// virtual. Desenvolvedores de aplicação não devem criar erros que herdam de
// Error.
...
// As primeiras são denominadas checked e são criadas através do pertencimento a
// uma hierarquia que não passe por RuntimeException.

// As segundas são as unchecked, e são criadas como descendentes de
// RuntimeException.
